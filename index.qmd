...
-   Deviation scores do not benefit classification accuracy when only use structural imaging data is used.
:::
...
![and to Thomas Wolfers for all the great supervision ☺️](imgs/place_holder.png)
