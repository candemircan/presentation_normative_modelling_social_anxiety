...
::: incremental
-   Due to the small sample size, the results should be interpreted carefully.
-   The next step is to inspect the quality of T1 images, and incorporate image quality into the analysis.
:::
:::
