...
::: {layout="[[-1], [1], [-1]]"}
![](imgs/norm_brain.png){fig-align="center"}
:::

# Estimating Norms - Structural Brain Data [@rutherford2022]

![](imgs/math.png){fig-align="center"}
...
-   Extreme fear and anxiety of social situations in proportion to the actual threat.
...
-   We find
-   Such deviations do not benefit classification methods only using brain data.
...
The sample size is really small, and you shout take the results with a grain of salt.
:::
:::

# Thank you for listening!{.centered background-image="imgs/thomas.png"}

and to Thomas Wolfers for all the great supervision ☺️
